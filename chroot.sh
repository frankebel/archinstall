...
efibootmgr --create --disk "/dev/$drive" --part 1 --label "Arch" --loader /vmlinuz-linux --unicode 'rd.luks.name='"$uuid_crypt"'=root root=/dev/mapper/root rw initrd=\'"$microcode"'.img initrd=\initramfs-linux.img quiet'
